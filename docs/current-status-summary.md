...
| Gmail 앱 비밀번호 | `YOUR_APP_PASSWORD_HERE` | ⚠️ 거부됨 |
| Slack Webhook | `https://hooks.slack.com/services/YOUR/WEBHOOK/URL` | ✅ 정상 |
| Anthropic API 키 | `sk-ant-api03-TmNw...` | ❌ 401 에러 |
...
**테스트한 API 키**:
1. `sk-ant-api03--15LCuuUd...` → 404 Not Found
2. `sk-ant-api03-Ezk9Bx4Gf...` → 401 Unauthorized
3. `sk-ant-api03-TmNwrHIeB...` → 401 Unauthorized (현재 사용 중)
...
- 앱 비밀번호: `YOUR_APP_PASSWORD_HERE`

**테스트 결과**:
- ❌ 공백 제거 (`zkbufiinnikeoysm`) → 실패
- ❌ 공백 포함 (`YOUR_APP_PASSWORD_HERE`) → 실패
