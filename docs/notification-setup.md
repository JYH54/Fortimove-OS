...
4. **채널 선택 및 허용**
   ...
   - "Allow" 클릭
   - Webhook URL 복사 (형식: `https://hooks.slack.com/services/T.../B.../...`)
...
```bash
# 일반 리포트용 Webhook (필수)
SCOUT_SLACK_WEBHOOK_URL=여기에_복사한_Webhook_URL_붙여넣기

# 긴급 알림용 Webhook (선택사항, 미입력시 일반 채널 사용)
SCOUT_SLACK_URGENT_WEBHOOK_URL=여기에_긴급용_Webhook_URL_붙여넣기
```
