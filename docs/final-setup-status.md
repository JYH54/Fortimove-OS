...
- ✅ Slack Webhook URL 설정: `https://hooks.slack.com/services/YOUR/WEBHOOK/URL`
...
**제공된 API 키**:
- 키 #1: `sk-ant-api03-YOUR_API_KEY_HERE` → 404
- 키 #2: `sk-ant-api03-YOUR_API_KEY_HERE` → 401
- 키 #3 (최신): `sk-ant-api03-YOUR_API_KEY_HERE` → 401
